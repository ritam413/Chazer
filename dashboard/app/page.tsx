    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-2xl w-full glass-card p-10 flex flex-col items-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-medium text-chazer-purple-light uppercase tracking-wider">
            Autonomous Accounts Receivable Agent
          </p>
        </div>

        <p className="text-base text-[#9090A8] max-w-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full pt-4">
          <div className="p-4 rounded-lg bg-surface-elevated border border-border-subtle flex flex-col items-center text-center space-y-1">
            ...
            <span className="text-xs font-semibold text-white">Tier 1 & 2 Auto</span>
            <span className="text-[11px] text-[#9090A8]">Friendly & firm follow-ups</span>
          </div>
          <div className="p-4 rounded-lg bg-surface-elevated border border-border-subtle flex flex-col items-center text-center space-y-1">
            <ShieldAlert className="w-5 h-5 text-tier3" />
            <span className="text-xs font-semibold text-white">Human Safeguard</span>
            <span className="text-[11px] text-[#9090A8]">High-value & final notices</span>
          </div>
          <div className="p-4 rounded-lg bg-surface-elevated border border-border-subtle flex flex-col items-center text-center space-y-1">
            <Sparkles className="w-5 h-5 text-chazer-purple-light" />
            <span className="text-xs font-semibold text-white">AI-Drafted</span>
            <span className="text-[11px] text-[#9090A8]">Contextualized email copy</span>
          </div>
        </div>
