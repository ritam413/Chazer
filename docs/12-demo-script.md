...
- Terminal: ready with `python -m agent.main --sandbox`
- Database state: Fresh seed ($96,990 across 8 active receivables)
...
- [ ] Decision queue has 4 items pending review
...
### 0:00 – 0:30 | Hook & Financial Stakes
